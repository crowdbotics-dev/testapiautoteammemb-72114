...
## Project Structure
    ...
    ├── testapiautoteammemb_72114  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_72114`
...
2. Clone this repo and `cd testapiautoteammemb_72114`
